...
echo '<div class="col-md-11 repeatedDivs search_result">
	...
	<div class="col-md-10 center-content">
		...
		echo '<table width="100%" style="color: #0045ab;">
			<tr>
				...
				<td width="20%">'; if ($resume != ''){ ; echo '<a href="../viewPdf.php?r='.$resume.'" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-download"></i></a>&nbsp;'; } if ($linkedUrl != ''){ echo '<a href="'.$linkedUrl.'" target="_blank" class="btn btn-sm btn-info"> <i class="fa fa-linkedin"></i></a>'; } echo '</td>
			</tr>
		</table><br>
	...
	<div class="col-md-12">
		<div class="col-md-6 posted-dt">
			...
			<label>Updated Date :  '.$updatedAt.' </label>
		</div>
		<div class="col-md-6 social-icons-home">';
		  echo '<input type="hidden" name="userId" id="userId_'.$postId.'" value="'.$userId.'">
				...
				echo '<span id="yes_cnt" class="yesCount_'.$postId.'">'.$cntYes.'</span>&nbsp;&nbsp;';
				 if($countofYes == 0){
				 	echo '<span class="activeHeart_'.$postId.'" style="cursor: pointer;" title="Yes. I am with you." onclick="postYes('.$postId.');"><i class="fa fa-heart-o" id="activeHeartIcon_'.$postId.'"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>';
				 }if($countofYes >= 1){
				 	echo '<span style="cursor: pointer;" title="Yes. I am with you." onclick="postYes('.$postId.');"><i class="fa fa-heart like-heart" id="activeHeartIcon_'.$postId.'"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>';
				 }

				echo '<span id="same_cnt" class="sameCount_'.$postId.'">'.$cntSimilar.' </span>&nbsp;&nbsp;';
				 if($countofSame == 0){ 
				echo '<span class="activeLike_'.$postId.'" title="I have similar experience." onclick="postSame('.$postId.')" style="cursor: pointer;"><i class="fa fa-thumbs-o-up" id="activeLikeIcon_'.$postId.'"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>'; } if($countofSame >= 1){ echo '<span style="cursor: pointer;" title="I have similar experience." onclick="postSame('.$postId.')"><i class="fa fa-thumbs-up like-symbol" id="activeLikeIcon_'.$postId.'"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>';  } 
				echo '<span id="cmts_cnt" class="cmtCount_'.$postId.'">'.$cntCmt.'</span>&nbsp;&nbsp;
				<a data-toggle="collapse" href="#collapseExample_'.$postId.'" role="button" aria-expanded="false" aria-controls="collapseExample" title="Comments" onclick="getCommentDiv('.$postId.');"><i class="fa fa-comment" style="color: #337ab7"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
				<div class="content collapse" id="collapseExample_'.$postId.'">
					<div class="col-md-12 liveCmt">
						...
						<div class="col-md-7 liveText">
							<div class="input-group">
							    ...
							    <textarea class="form-control cmt-txt" name="comments" id="comments'.$postId.'" style="background-color: #f5f5f5; border-left: none;"></textarea>
							</div>
						</div>
						<div class="col-md-3">
...
<script>  
	...
	$(document).ready(function(){
		var websocket = new WebSocket("ws://localhost:8080/trust_people_us/view/php-socket.php"); 
