...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <img src="../../assets/images/logo.png" class="img-responsive" style="width:100%" alt="Image">
    </div>

    <!-- Sets Links -->
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="../login/enterpriseSign_up.php"> For Enterprise</a></li>
        <li><a href="../login/registerUser.php"> Sign In</a></li>
        <li><a href="../login/registerUser.php" class="btn btn-primary"> Register</a></li>
    </div>
  </div>
</nav>
...
<div class="container">
  <img src="../../assets/images/share_experience.png" style="width:100%;">
  <div class="text-block">
    
    <h1>Share your experiences about hiring.</h1>
  </div>
</div>
</div>
