	...
	<div class="col-md-12">
		...
		<div class="col-md-6 social-icons-home">';
		  echo '<input type="hidden" name="userId" id="userId_'.$postId.'" value="'.$userId.'">
				...
				echo '<ul>
				        <li>
				        <span id="yes_cnt" class="yesCount_'.$postId.'">'.$cntYes.'</span>&nbsp;&nbsp;&nbsp;';
				            if($countofYes == 0){
							 	echo '<span class="activeHeart_'.$postId.'" style="cursor: pointer;" onclick="postYes('.$postId.');"><i class="fa fa-thumbs-o-up" id="activeHeartIcon_'.$postId.'"></i><span class="trust-lbl" onmouseover="getTrustableList('.$postId.')"> Trustable</span> </span>&nbsp;&nbsp;&nbsp;';
							 }if($countofYes >= 1){
							 	echo '<span style="cursor: pointer;" onclick="postYes('.$postId.');"><i class="fa fa-thumbs-up like-symbol" id="activeHeartIcon_'.$postId.'"></i><span class="trust-lbl" onmouseover="getTrustableList('.$postId.')"> Trustable</span> </span>&nbsp;&nbsp;&nbsp;';
							 }
				...
				echo '<li><span id="same_cnt" class="sameCount_'.$postId.'">'.$cntSimilar.'</span>&nbsp;&nbsp;&nbsp;';
				 if($countofSame == 0){ 
				echo '<span class="activeLike_'.$postId.'" onclick="postSame('.$postId.')" style="cursor: pointer;"><i class="fa fa-thumbs-o-down" id="activeLikeIcon_'.$postId.'"></i><span class="un-trust-lbl" onmouseover="getUnTrustableList('.$postId.')"> Untrustable</span></span>&nbsp;&nbsp;&nbsp;'; } if($countofSame >= 1){ echo '<span style="cursor: pointer;" onclick="postSame('.$postId.')"><i class="fa fa-thumbs-down like-symbol" id="activeLikeIcon_'.$postId.'"></i><span class="un-trust-lbl" onmouseover="getUnTrustableList('.$postId.')"> Untrustable</span></span>&nbsp;&nbsp;&nbsp;';  } 
