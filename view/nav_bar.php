...
<div class="topnav" id="myTopnav">
  <!-- <a href="#"> -->
	...
	<?php }else{ ?>
		<img src="../../assets/images/trustpeople_logo_png.png" alt="trust_people_logo" class="nav_logo">
	<?php } ?> -->
	<a class="navbar-brand" href="../home/" style="color: #fff;"><b>Trust People</b></a>  		
  <!-- </a> -->
	<!-- <div class="dropdown">
	...
	<div class="dropdown btn-group mobile-dp-logout">
	    ...
	    <div class="dropdown-menu settings-dropdown">
  	        <a href="../../" class="web-logout" style="width: 100%;">Logout</a>
	    </div>
	</div>
  <?php 
	if($user_image == NULL){ ?>
	<a href="../profile/?userId=<?php echo $user_id; ?>" class="imageA"><img class="userImg" src="../../userImage/user.png" alt="<?php echo $first_name."-".$last_name; ?>">&nbsp;&nbsp;<?php echo ucfirst($first_name). " " .ucfirst($last_name); ?></a>
	<?php
		}else{ ?>
	<a href="../profile/?userId=<?php echo $user_id; ?>" class="imageA"><img class="userImg" src="../../userImage/<?php echo $user_image; ?>" alt="<?php echo $first_name."-".$last_name; ?>">&nbsp;&nbsp;<?php echo ucfirst($first_name). " " .ucfirst($last_name); ?></a>
	<?php } ?>
	...
	<a href="../../" class="mobile-logout">Logout</a>
