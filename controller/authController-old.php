<?php 
	...
	if(isset($_POST['signin']))
	{
		...
		$sql = "SELECT `register_id`, `first_name`, `last_name`, `flag`, `status` FROM `register_tbl` WHERE email_address = '".$username."' AND password = '".$password."'";
		...
		if($status == ''){
			$checkStatus = execute_query($conn, "SELECT `register_id`, `first_name`, `last_name`, `flag`, `status`, `password` FROM `register_tbl` WHERE email_address = '".$username."' AND password = '".$password."' AND status = '".$status."'");
			if($checkStatus){
			...
			$loginUser = execute_query($conn, "SELECT `register_id`, `first_name`, `last_name`, `flag`, `status`, `password` FROM `register_tbl` WHERE email_address = '".$username."' AND password = '".$password."' AND status = '".$status."'");
	...
	if(isset($_POST['signup']))
	{
		...
		$sql = "INSERT INTO `register_tbl` (`first_name`, `last_name`, `email_address`, `encrypted_password`, `password`, `flag`, `status`) VALUES ('".$firstName."', '".$lastName."', '".$emailAddress."', '".$userPassword."', '".$password."', '".$flag."', '".$status."')";
